...
app.on('ready', function() {
  ...
  var child = require('child_process').spawn('python', ['./app.py']); //Make an instance of child process of server
  //The executable file in the above line should be hello.exe in case of Windows
  var rq = require('request-promise');
  var main = 'http://localhost:5000';

  var openWindow = function(){
    mainWindow = new BrowserWindow({width:800, height: 600 , title: "Electron using flask server", "node-integration": false}); //Dimensions of the window
